<?php 
        class SisProfSchedItemAfwStructure
        {
			public static function initInstance(&$obj)
			{
				if ($obj instanceof ProfSchedItem) 
				{
					$obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 15;
					$obj->DISPLAY_FIELD = "class_name";
					$obj->ORDER_BY_FIELDS = "prof_id, school_year_id, wday_id, session_order";
					$obj->commonFields=true;
					$obj->VIEW = true;
					$obj->VIEW_TABLES = array("course_sched_item"=>"خطة الدروس الأسبوعية","school_class_course"=>"المدرس لكل مادة لكل صف");
					$obj->READONLY = true;
				}
			}
			...
			'school_year_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true,  'SHOW' => true,  'RETRIEVE' => true,  'EDIT' => true,  'QEDIT' => true,  'SIZE' => 40,  'SEARCH-ADMIN' => true,  'SHOW-ADMIN' => true,  'EDIT-ADMIN' => true,  'UTF8' => false,  
				'TYPE' => 'FK',  'ANSWER' => 'school_year',  'ANSMODULE' => 'sis',  'DEFAUT' => 0,  'READONLY' => true,  
			...
			'class_name' => array('IMPORTANT' => 'IN',  'SEARCH' => true,  'SHOW' => true,  'RETRIEVE' => true,  'EDIT' => true,  'QEDIT' => true,  'SIZE' => 1,  'SEARCH-ADMIN' => true,  'SHOW-ADMIN' => true,  'EDIT-ADMIN' => true,  
				'TYPE' => 'TEXT',  
				// 'ANSWER' => 'a,أ|b,ب|c,ت|d,ث|e,ج|f,ح|g,خ',  'ENUM_ALPHA' => true,  
				'QSEARCH' => true,  'READONLY' => true,  'ANSMODULE' => 'sis',  'DISPLAY' => true,  'STEP' => 1,  
				'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
				'CSS' => 'width_pct_100',),
			...
			'session_start_time' => array('IMPORTANT' => 'IN',  'SEARCH' => true,  'SHOW' => true,  'RETRIEVE' => true,  'EDIT' => true,  'QEDIT' => true,  'SIZE' => 5,  'SEARCH-ADMIN' => true,  'SHOW-ADMIN' => true,  'READONLY' => true,  
				'TYPE' => 'TIME',    'DISPLAY' => true,  'STEP' => 1,  
				'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
				'CSS' => 'width_pct_100',),

			'session_end_time' => array('IMPORTANT' => 'IN',  'SEARCH' => true,  'SHOW' => true,  'RETRIEVE' => true,  'EDIT' => true,  'QEDIT' => true,  'SIZE' => 5,  'SEARCH-ADMIN' => true,  'SHOW-ADMIN' => true,  'READONLY' => true,  
				'TYPE' => 'TIME',    'DISPLAY' => true,  'STEP' => 1,  
				'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
				'CSS' => 'width_pct_100',),
			...
			'prof_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true,  'SHOW' => true,  'RETRIEVE' => true,  'EDIT' => true,  'QEDIT' => true,  'SIZE' => 40,  'SEARCH-ADMIN' => true,  'SHOW-ADMIN' => true,  'EDIT-ADMIN' => true,  'UTF8' => false,  
				...
				'WHERE' => "school_job_mfk like '%,3,%' and course_mfk like concat('%,',§course_id§,',%')", 
				   'DISPLAY' => true,  'STEP' => 1,  
				'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
				'CSS' => 'width_pct_100',),
