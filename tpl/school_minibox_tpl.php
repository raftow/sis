<?php
        ...
        if($currSYear)
        {
                $schoolClassList = $currSYear->het("schoolClassList");
                        ...
                        <div class='my_school_ticket title'>
                                <h3>
                                        <div class='my_school_title fright'>
                                                <a target='_myschool' class='sis title' href='./m.php?mp=ed&cl=School&id=<?php echo $schoolId ?>&currmod=sis&currstep=6'>إدارة <?php echo $schoolObj->getShortDisplay("ar"); ?></a> 
                                        </div>
