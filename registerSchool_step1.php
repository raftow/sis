<div class="modal-dialog">
        <div class="modal-content">
                        <?
                          //
                         $register_title = AfwLanguageHelper::tarjemMessage("REGISTER_SCHOOL_PARAMS_TITLE",$uri_module); 
                         $register_sentence = AfwLanguageHelper::tarjemMessage("REGISTER_SCHOOL_PARAMS_SENTENCE",$uri_module);
                         // $register_data_type = AfwLanguageHelper::tarjemMessage("REGISTER_DATA_TYPE",$uri_module);
                         $register_conditions = AfwLanguageHelper::tarjemMessage("REGISTER_SCHOOL_PARAMS_CONDITIONS",$uri_module);
