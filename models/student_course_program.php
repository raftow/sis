<?php
// ------------------------------------------------------------------------------------
// ----             auto generated php class of table student_course_program : student_course_program - الملفات السنوية لطالب(ة) بوحدة دراسية
// ------------------------------------------------------------------------------------
...
class StudentCourseProgram extends SisObject
{
    ...
    public static $TABLE = 'student_course_program';
    public static $DB_STRUCTURE = null;

    public function __construct()
    {
        parent::__construct('student_course_program', '', 'sis');
        SisStudentCourseProgramAfwStructure::initInstance($this);
    }
    ...
    public function beforeMAJ($id, $fields_updated)
    {
        ...
        /*
               ...
               if(!$this->getVal("school_class_id")) return $this->completeStudentCourseProgram($options);
               else 
               {
    ...
    public function completeStudentCourseProgram($options)
    {
        global $file_dir_name, $lang;
    ...
    
    {
        ...
        if ($school_id and $student_id and $year and $levels_template_id and $school_level_order and $level_class_order) {
            ...
            if ($overwrite_data or $studentFile->is_new) {
                ...
                $studentFile->completeStudentCourseProgram($options);
    ...
    public function shouldBeCalculatedField($attribute){
        ...
        if($attribute=="age") return true;
        if($attribute=="is_qualif_diploma") return true;
        if($attribute=="is_diploma") return true;
        if($attribute=="level_class_id") return true;
        if($attribute=="school_class_id") return true;
        return false;
    }
