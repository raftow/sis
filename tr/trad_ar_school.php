<?php
	...
	$trad["school"]["presence_mfk"] = "أنواع الحضور";


	$trad["school"]["age_coef"] = "ضارب العمر";
	$trad["school"]["eval_coef"] = "ضارب الاختبار";
	$trad["school"]["moral_coef"] = "ضارب الأخلاق";
	$trad["school"]["capacity_coef"] = "ضارب القدرات";
	$trad["school"]["general_max"] = "التقييم الشامل الأقصى";
	$trad["school"]["coef"] = "معايير التقييم الشامل لتحديد المستوى";
	
	$trad["school"]["age_distrib"] = "ضارب العمر";
	$trad["school"]["eval_distrib"] = "ضارب الاختبار";
	$trad["school"]["moral_distrib"] = "ضارب الأخلاق";
	$trad["school"]["capacity_distrib"] = "ضارب القدرات";
	$trad["school"]["distrib"] = "معايير خوارزمية التوزيع";
	
	
	$trad["school"]["address"] = "العنوان";
	$trad["school"]["pc"] = "الترقيم البريدي";
	$trad["school"]["quarter"] = "الحي";
	...
	$trad["school"]["sp1"] = "عدد الدقائق قبل فتح الحصة الدراسية للمدرس";
	$trad["school"]["sp2"] = "النسبة المنقضية من الدرس قبل امكان غلقه";
	$trad["school"]["we_mfk"] = "أيام عطلة نهاية الاسبوع";
	$trad["school"]["lang_id"] = "لغة التعامل الافتراضية";
	$trad["school"]["levels_template_id"] = "نموذج المستويات الدراسية";
	...
	$trad["school"]["study_program_id"] = "المنهج الافتراضي";
	...
	$trad["school"]["license_start_date"] = "تاريخ بداية الترخيص";
	$trad["school"]["license_end_date"] = "تاريخ نهاية الترخيص";
