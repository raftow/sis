<?php
	$trad["holiday"]["holiday.single"] = "عطلة";
	$trad["holiday"]["holiday.new"] = "جديد";
	$trad["holiday"]["holiday"] = "العطل";
	$trad["holiday"]["country_id"] = "البلد";
	$trad["holiday"]["school_id"] = "النظام المدرسي";
	$trad["holiday"]["year"] = "السنة الدراسية";
